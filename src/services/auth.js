 ...
 *
 * ✅ DÜZELTME: validateToken fonksiyonunda Authorization header eklendi
 *
...
export const authService = {
            ...
            if (response.data.isSuccess) {
                ...
                if (validatedUser) {
                    ...
                    const authCookieData = {
                        ...
                        token: result.token, // Her iki key ile de sakla
     ...
     *
     * ✅ DÜZELTME: Authorization header eklendi
     *
    ...
    async validateToken(token) {
        try {
            ...
            if (error.response?.status === 401) {
                console.error('❌ 401 Unauthorized - Token geçersiz veya header eksik');
            }
